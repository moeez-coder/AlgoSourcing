...
- **Seniority include:** CXO, Managing Director, Partner, Director, Owner
- **Job titles (draft):** Managing Partner, Managing Director, Founder, CEO,
  President, Head of Business Development, VP Origination/Deal Sourcing
- Drafted from Algo's stated buyer profile; not yet validated specifically for
  the M&A-advisory vertical. Refine once real results come back.
